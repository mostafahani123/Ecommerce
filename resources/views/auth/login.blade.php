...
<!--Main layout-->
<form style="width: 50%; margin-left:60vh;" class="mb-5 " method="POST" action="{{ url('/login') }}">
  @csrf
              <div class="mb-3 mt-3 " >
                  <input type="text" class="form-control bg-dark text-light"  id="email"  placeholder="Enter username" name="fristname">
              </div>
              <div class="mb-3 mt-3 ">
                   <input type="text" class="form-control bg-dark text-light" id="email"   placeholder="Enter password" name="password">
              </div>
